...
class OpenStack(abstract_driver.DeviceAbstractDriver,
    ...
    def create(self, plugin, context, vnf, auth_attr):
        ...
        tth.generate_hot()
        stack = self._create_stack(heatclient, tth.vnf, tth.fields,auth_attr,region_name)
    ...
    def _create_stack(self, heatclient, vnf, fields,auth_attr,region_one):
        ...
        print("#######################################################")
        print("#######################################################")
        print("############### _create_stack in Infra_drivers / openstack.py : 5")
        print("#######################################################")
        print("#######################################################")
        print("#######################################################")
        print("#######################################################")
        ...
        print("#######################################################")
        print("#######################################################")
        print("############### _create_stack in Infra_drivers / openstack.py : Line 153")
        print("############### fileds : ",fields)
        print("#######################################################")
        print("#######################################################")
        print("\n")
